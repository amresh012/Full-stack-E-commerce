...
If you transact with us, we may collect some additional information, such as a billing address, a credit / debit card number and a credit / debit card expiration date and/ or other payment instrument details and tracking information from cheques or money orders.
...
We collect personally identifiable information (email address, name, phone number etc.) from you when you set up a free account with us. While you can browse some sections of our Website without being a registered member, certain activities (such as placing an order) do require registration. We do use your contact information to send you offers based on your previous orders and your interests. We will also use your personal information to communicate with you about the Website and your orders and deliveries. Also, we may send you a confirmation email when you register with us. We may send you a service-related announcement on the rare occasions when it is necessary (for example, if we must temporarily suspend our service for maintenance). </p>
      <br/>
      <li className="italic font-bold text-xl">Credit Card, Debit Card and Banking Information</li>
      <br/>
      <br/>
      <p>We do not collect or store Credit Card or Debit Card or banking information. Such information may be provided by you during the purchase transaction. However this data does not come to us. It is directly transmitted through the payment gateway provider to the payment network or bank. No information is stored by us.</p>
      </ol>
      <ul className='w-full pt-12   '>
        <li className='font-bold text-xl italic text-start'>Data Hoisting</li>
        <p className="italic text-black/80 font-bold leading-10">
        The website is hosted with third party data hosting specialists. Information collected is kept on servers owned and managed by data hosting companies, which may be in India or overseas including the United States of America. The companies being used by Us are expected to be PCI compliant and have data security processes in place. However We are not liable for any data theft or breach of security at the data centres hosting the website and holding consumer data
        </p>

        <ol className='list-decimal pt-12 px-12 '>
            <li className="font-bold italic text-slate-500 pb-12">Use of Demographic / Profile Data / Your Information</li>
            <p>We may use personal information to provide the services you request. We may use your personal information to resolve disputes; troubleshoot problems; help promote a safe service; collect money measure, consumer interest in our products and services, inform you about online and offline offers, products, services, and updates; customize your experience; detect and protect us against error, fraud and other criminal activity; enforce our terms and conditions; and as otherwise described to you at the time of collection</p>
            <br />
            <p>With your consent, we will have access to your SMS, contacts in your directory, call history, location and device information and we may request you to provide your PAN details to check your eligibility for certain products/services including but not limited to providing credit) being offered by us, our affiliates or our lending partners. We may share this data with our affiliates or our lending partners for the same purposes as mentioned above. In the event that consent to this such use of data is withdrawn in the future, we will stop collection of such data but continue to store the data (save for Aadhaar data) and use it for internal purposes to further improve our services.</p>
            <br />
            ...
            <br />
            <p>We may also use your personal information to display contents and services that are targeted to your interests. You expressly agree to receive this information.  </p>
            <br />
           
        </ol>
      </ul>

      <ul className="pt-12 w-full">
        <li className="font-bold text-xl italic text-start">Cookies</li>
        <p className="italic text-black/80 font-bold leading-10">A “cookie” is a small piece of information stored by a web server on a web browser so it can be later read back from that browser. Cookies are useful for enabling the browser to remember information specific to a given user. We place both permanent and temporary cookies in your computer’s hard drive. The cookies do not contain any of your personally identifiable information.</p>
      
       <ol className=''>
        <li className='font-bold italic text-slate-500 pb-12'>Sharing of personal information</li>
        <p>We may share personal information with our other corporate entities and affiliates. These entities and affiliates may market to you as a result of such sharing.</p>
        <br />
