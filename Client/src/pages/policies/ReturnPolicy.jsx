    ...
    <div className="py-10">
      <div className="max-w-4xl mx-auto bg-white p-8 ">
        ...
        <p className="text-gray-600 mb-4">
          We hope you love your purchase, but if you are not completely satisfied, we’re here to help. Our return policy is designed to ensure that our customers have a seamless and easy return experience.
        </p>
        ...
        <p className="text-gray-600 mb-4">
          Certain items are non-returnable and non-refundable, including gift cards, downloadable software products, and some health and personal care items.
        </p>
